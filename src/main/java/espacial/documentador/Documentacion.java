...
public class Documentacion {
    ...
    public void escribirTitulo(String titulo) {
        ...
        archivo.printf("<h1>%s</h1>", titulo);
    }

    public void escribirParrafo(String parrafo) {

        archivo.printf("<p>%s</p>", parrafo);
    }

    public void escribirTipo(String nombre) {

        archivo.printf("<h3>Tipo</h3><pre><code>%s</code></pre>", nombre);
    ...
    public void escribirDescripcion(String texto) {
        ...
        archivo.printf("<h4>Descripción</h4><p>%s</p>", texto);
    }
    ...
    public void escribirConstructor(String codigo) {
        ...
        if (!escribioUnConstructor.getAndSet(true)) {
            ...
            archivo.printf("<h4>Constructores</h4>%n");
        }

        archivo.printf("<div class=\"row\">%n")
                .printf("<div class=\"one column\">&nbsp;</div>%n")
                .printf("<div class=\"eleven columns\">%n")
                .printf("<pre><code>%s</code></pre>%n", codigo)
                .printf("</div>%n")
                .printf("</div>%n");
    }
    ...
    public void escribirMetodo(String codigo) {
        ...
        if (!escribioUnMetodo.getAndSet(true)) {
            ...
            archivo.printf("<h4>Métodos</h4>%n");
        }
        archivo.printf("<div class=\"row\">%n")
                .printf("<div class=\"one column\">&nbsp;</div>%n")
                .printf("<div class=\"eleven columns\">%n")
    ...
    public void escribirPre(String texto) {
        ...
        escribirCondicion("pre", texto);
    }

    public void escribirPost(String texto) {

        escribirCondicion("post", texto);
    }

    public void escribirRetorno(String texto) {

        escribirCondicion("retorno", texto);
    }

    private void escribirCondicion(String tipo, String texto) {

        archivo.printf("<div class=\"row\">%n")
                .printf("<div class=\"two columns\">&nbsp;</div>%n")
                .printf("<div class=\"one column\"><strong>%s</strong></div>%n", tipo)
                .printf("<div class=\"nine columns\">%s</div>%n", texto)
                .printf("</div>%n");
    }

    public void escribirParametro(String nombre, String descripcion) {

        escribirCondicion("&nbsp;", nombre + ": " + descripcion);
    }

    public void escribirValoresEnumerados(List<String> valores) {

        archivo.printf("<h4>Valores</h4>%n")
                .printf("<div class=\"row\">%n")
                .printf("<div class=\"six columns\">%n");

        for (String valor : valores) {

            archivo.printf("<pre><code>%s</code></pre>%n", valor);
        }

        archivo.printf("</div>%n")
                .printf("<div class=\"six columns\">&nbsp;</div>%n")
                .printf("</div>%n");
    }
}
